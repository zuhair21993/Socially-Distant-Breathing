...
export function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["counties-albers-10m.json",new URL("./counties-albers-10m.json",import.meta.url)],["aqi_limited_1980.csv",new URL("./aqi_limited_1980.csv",import.meta.url)]]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
//   main.variable(observer()).define(["md"], function(md){return(
// md`# Air Quality Index (AQI) - Poor Air Quality Days, 1980.`
// )});
...
Object.assign(new Map(d3.csvParse(await FileAttachment("aqi_limited_1980.csv").text(), ({id, Unhealthy}) => [id, +Unhealthy])), {title: "Unhealthy days"})
)});
